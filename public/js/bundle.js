...
const displayMap = locations => {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FtbXl0ZWNoIiwiYSI6ImNsdjI0cndlMDA2Mm4ybG11aWVyaTFscGkifQ.IoxhkshOZ5BciTegyD-yhA';
...
const updateUserSettings = async (data, type) => {
  try {
    ...
    if (res.data.status === 'success') {
      (0, _alert.showAlert)('success', `Successfully updated ${type === 'data' ? 'data' : 'password'}`);
    }
  } catch (err) {
...
const bookTour = async tourId => {
  ...
  try {
    const session = await (0, _axios.default)(`http://127.0.0.1:8000/api/v1/bookings/checkout-session/${tourId}`);
...
},{"core-js/modules/web.timers.js":"../../node_modules/core-js/modules/web.timers.js","core-js/modules/web.immediate.js":"../../node_modules/core-js/modules/web.immediate.js","core-js/modules/web.dom.iterable.js":"../../node_modules/core-js/modules/web.dom.iterable.js","./login":"login.js","./mapBox":"mapBox.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
